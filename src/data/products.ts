...
export const products: Product[] = [
  ...
  {
    slug: "mixed-color-portulaca-seeds",
...
const defaultReviews: Review[] = [
  {
    ...
    location: "ঢাকা",
    rating: 5,
    text: "বীজের প্যাকগুলো অনেক ভালো ছিল। প্রায় সব বীজ থেকে সুন্দর সুন্দর রঙ-বেরঙের ফুটফুটে চারা গজিয়েছে!",
  },
  {
    name: "আব্দুল করিম",
    location: "বগুড়া",
  ...
  },
  {
    ...
    location: "সিলেট",
    rating: 5,
    text: "ছাদ বাগানে টবে লাগিয়েছিলাম। খুব অল্প দিনেই মাশাল্লাহ প্রচুর ফুল ফুটেছে, বাগানটাই দেখতে অসাধারণ লাগছে।",
  },
];

const defaultFaqs: Faq[] = [
  { q: "একটি প্যাকেটে কতটি বীজ থাকে?", a: "প্রতিটি প্যাকেটে ৫০টিরও বেশি উচ্চ ফলনশীল প্রিমিয়াম বীজ থাকে।" },
  ...
  { q: "কত দিনে গাছে ফুল ফোটে?", a: "বীজ থেকে চারা বের হওয়ার ৩০ থেকে ৫০ দিনের মধ্যেই গাছে প্রচুর উজ্জ্বল ও নয়নজুড়ানো ফুল ফুটতে শুরু করে।" },
];
...
const landingOverrides: Partial<Record<string, Partial<LandingContent>>> = {
  ...
  "mixed-color-portulaca-seeds": {
    headline: "সহজ পরিচর্যায় ছাদ ও বেলকনি ভরিয়ে তুলুন রঙিন পর্তুলিকা (টাইম) ফুলে",
    subheadline: "আমাদের হাই-জার্মিনেশন প্রিমিয়াম প্যাকেটের মিক্স কালার পর্তুলিকা/টাইম ফুল চাষ করে আপনার ছাদ বাগানকে সারাদিন ভরিয়ে রাখুন নয়নজুড়ানো রঙের খেলায়।",
    highlights: [
      "অফুরন্ত রঙ-বেরঙের থোকা ফুলের বৈচিত্র্য (লাল, গোলাপী, হলুদ, সাদা, কমলা, বেগুনী)",
      "অল্প পরিচর্যাতেই দ্রুত বৃদ্ধি ও প্রচুর ফুল আসার নিশ্চয়তা (৩০–৪০ দিনে ফুল)",
      "টব, ব্যালকনি বক্স ও ঝুলন্ত টবের জন্য অত্যন্ত জনপ্রিয় ফুল জাত",
      "৯৫%+ অংকুরোদগমের সেরা ল্যাব-টেস্টেড ফ্রেশ ফয়েল প্যাক",
    ],
    description: [
      "পর্তুলিকা (Portulaca) বা টাইম ফুল ছাদ বাগান ও বেলকনির জন্য অন্যতম জনপ্রিয় রঙিন ফুল গাছ। মিক্স কালার পর্তুলিকা বীজের এই প্যাকেটে আপনি পাবেন লাল, গোলাপী, হলুদ, সাদা, বেগুনী ও কমলার মতো উজ্জ্বল ও আকর্ষণীয় রঙের দারুণ সংমিশ্রণ।",
      "এই বীজ অতি দ্রুত অঙ্কুরিত হয় এবং রোপণের মাত্র ৩০ থেকে ৪০ দিনের মধ্যেই গাছজুড়ে অজস্র ফুল ফুটতে শুরু করে। রোদ উজ্জ্বল স্থানে টবে ও ঝুলন্ত টবে খুব সুন্দর জন্মায়। প্রতিটি ফয়েল প্যাক এয়ার-টাইট ও সম্পূর্ণ আর্দ্রতারোধী।",
    ],
    usage: [
      "বীজ অতি ক্ষুদ্র হওয়ায় বীজ বপনের আগে ঝুরঝুরে শুষ্ক বালু বা মাটির সাথে মিশিয়ে নিন।",
      "টব বা পাত্রের উপরিভাগে হালকা করে ছিটিয়ে দিন, গভীর মাটিতে পুঁতবেন না।",
      "স্প্রে বোতল দিয়ে হালকা পানি ছিটিয়ে কড়া রোদ থেকে রক্ষা করুন (৩–৫ দিনে চারা গজাবে)।",
      "চারা ২ ইঞ্চি হলে পর্যাপ্ত আলো বাতাসযুক্ত স্থানে ও টবে রেখে নিয়মমতো পানি দিন।",
    ],
  },
};
